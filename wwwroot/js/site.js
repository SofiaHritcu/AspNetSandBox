...
function generateHTMLDailyWeatherForecasts(weather, index) {
    ...
    document.getElementById("currentWeatherIcon" + index).setAttribute('src', 'http://openweathermap.org/img/wn/' + weather.dailyForecasts[index].dailyIconCode + '@2x.png');
...
const main = async () => {
    ...
    document.getElementById('currentWeatherIcon').setAttribute('src', 'http://openweathermap.org/img/wn/' + weather.currentIconCode + '@2x.png')
    ...
    document.getElementById("currentWeatherIconHours").setAttribute('src', 'http://openweathermap.org/img/wn/' + weather.dailyForecasts[0].dailyIconCode + '@2x.png');
